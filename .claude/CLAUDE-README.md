...
Este proyecto implementa el **Reto IA Center: Cotizador de Daños** usando metodología **ASDD**.

Ver detalles completos: [`.claude/reto/RETO.md`](./reto/RETO.md)

**Fecha de entrega:** 2026-03-30 18:00  
**Metodología:** ASDD + Agentes Claude Code  
**Bloques principales:**
- Backend: plataforma de cotización de daños
- Frontend: SPA de captura y consulta
- Database: esquemas y modelos de datos
